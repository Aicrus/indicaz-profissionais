...
import 'termos_condicoes_apple_model.dart';
export 'termos_condicoes_apple_model.dart';

class TermosCondicoesAppleWidget extends StatefulWidget {
  const TermosCondicoesAppleWidget({super.key});

  @override
  State<TermosCondicoesAppleWidget> createState() =>
      _TermosCondicoesAppleWidgetState();
}

class _TermosCondicoesAppleWidgetState
    extends State<TermosCondicoesAppleWidget> {
  late TermosCondicoesAppleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TermosCondicoesAppleModel());
                    ...
                    : FFButtonWidget(
                        onPressed: () async {
                          if (_model.checkboxValue == true) {
                            ...
                            _model.profissionalUser2 = await actions.getUser();
                            _model.verificacaoUserMorador2 =
                                await UserResidentTable().queryRows(
                              queryFn: (q) => q.eqOrNull(
                                'email',
                                _model.profissionalUser2?.id,
                              ),
                            );
                            _model.verificacaoUseProfissional2 =
                                await UserProfissionaisTable().queryRows(
                              queryFn: (q) => q.eqOrNull(
                                'email',
                                _model.profissionalUser2?.email,
                              ),
                            );
                            if (((_model.verificacaoUserMorador2 != null &&
                                        (_model.verificacaoUserMorador2)!
                                            .isNotEmpty) ==
                                    true) &&
                                ((_model.verificacaoUseProfissional2 != null &&
                                        (_model.verificacaoUseProfissional2)!
                                            .isNotEmpty) ==
                                    false)) {
                            ...
                            } else if (((_model.verificacaoUserMorador2 !=
                                            null &&
                                        (_model.verificacaoUserMorador2)!
                                            .isNotEmpty) ==
                                    false) &&
