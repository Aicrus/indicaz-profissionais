                                                                    ...
                                                                    child:
                                                                      ...
                                                                      action:
                                                                        ...
                                                                        if (_model.formKey.currentState ==
                                                                          ...
                                                                          safeSetState(() =>
                                                                              _model.formulario3 = false);
                                                                          return;
                                                                        }
                                                                        if (((_model.verificacaoUserMorador != null && (_model.verificacaoUserMorador)!.isNotEmpty) ==
                                                                                true) ||
                                                                            (((_model.verificacaoUseProfissional != null && (_model.verificacaoUseProfissional)!.isNotEmpty) == true) &&
                                                                                (_model.verificacaoUseProfissional?.firstOrNull?.isOnbarding == true))) {
                                                                          if (((_model.verificacaoUserMorador != null && (_model.verificacaoUserMorador)!.isNotEmpty) == true) &&
                                                                              ((_model.verificacaoUseProfissional != null && (_model.verificacaoUseProfissional)!.isNotEmpty) == false)) {
                                                                          ...
                                                                          if (((_model.verificacaoUseProfissional != null && (_model.verificacaoUseProfissional)!.isNotEmpty) == true) &&
                                                                              (_model.verificacaoUseProfissional?.firstOrNull?.isOnbarding == false)) {
                                                                            FFAppState().pass =
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            wrapWithModel(
                                              model:
                                                  _model.loginsGoogleAppleModel,
                                              updateCallback: () =>
                                                  safeSetState(() {}),
                                              child: LoginsGoogleAppleWidget(),
                                            ),
                                          ],
                                        ),
