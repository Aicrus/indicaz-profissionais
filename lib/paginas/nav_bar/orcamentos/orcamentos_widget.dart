...
class OrcamentosWidget extends StatefulWidget {
  ...
  static String routeName = 'Orcamentos';
  static String routePath = '/orcamentos';
                                            ...
                                            image: Image.network(
                                              valueOrDefault<String>(
                                                _model.userProfissional
                                                    ?.firstOrNull?.foto,
                                                'https://images.unsplash.com/photo-1560250097-0b93528c311a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyMnx8cHJvZmlsZXxlbnwwfHx8fDE3NDcyNjUxNjd8MA&ixlib=rb-4.1.0&q=80&w=1080',
                                              ),
                                            ).image,
                                          ),
